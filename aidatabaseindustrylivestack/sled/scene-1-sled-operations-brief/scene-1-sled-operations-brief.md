...
The application covers more than Medicaid. The eligibility metric motivates one connected investigation across **Colorado**'s broader resident-service portfolio, so presenters should avoid framing the walkthrough as a Medicaid-only demo.
...
<video controls width="100%">
  <source src="https://c4u04.objectstorage.us-ashburn-1.oci.customer-oci.com/p/EcTjWk2IuZPZeNnD_fYMcgUhdNDIDA6rt9gaFj_WZMiL7VvxPBNMY60837hu5hga/n/c4u04/b/livelabsfiles/o/livestack/Videos/State-and-Local-Gov/State and Local Government_Intro_Scene1_with-CC.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

### Objectives

In this scene, you will establish **Jessica Chen**'s role, confirm the single-state **Colorado** scope, and understand how the eleven scenes resolve one operating decision.

## Task 1: Establish the Colorado operating decision

Perform the following set of steps to establish the **Colorado** operating decision and orient the audience to **Jessica Chen**'s role:
...
Perform the following set of steps to begin the governed investigation and move from orientation into the shared data foundation:
