...
2. Select the following link to open the stack-creation page with the High Tech Terraform package already selected:

    [Deploy the High Tech LiveStack with OCI Resource Manager](https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/oracle-livelabs/livestack/raw/refs/heads/main/aidatabaseindustrylivestack/terraform-ready-livestack/hightech/hightech-livestack-terraform.zip)
